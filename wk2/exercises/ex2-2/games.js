...
const arrIndex = response - 1;

window.alert('You selected ' + games[arrIndex].title + ' which is a ' + games[arrIndex].type + '. Up to ' + games[arrIndex].numberOfPlayers + ' people can play. I rate it as ' + games[arrIndex].rating + ' out of 10. ' + games[arrIndex].shortDescription);